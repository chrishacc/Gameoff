...
public class Incorporate : MonoBehaviour
{
    ...
    public void OnPointerClick()
    {
        ...
        if (pmata >= cost)
        {
            if (num >= 1)
            {
                ...
                GameObject.Find("BattleController").GetComponent<BattleController>().Change_HP(5, 5);
                GameObject.Find("BattleController").GetComponent<BattleController>().magic_dmg += 1;
