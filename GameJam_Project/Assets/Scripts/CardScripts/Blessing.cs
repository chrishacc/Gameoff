...
public class Blessing : MonoBehaviour
{
    ...
    public void OnPointerClick()
    {
        ...
        if (pmata >= cost)
        {
            GameObject.Find("BattleController").GetComponent<BattleController>().batper = (float)0.5;
            GameObject.Find("BattleController").GetComponent<BattleController>().batper_time = 4;
